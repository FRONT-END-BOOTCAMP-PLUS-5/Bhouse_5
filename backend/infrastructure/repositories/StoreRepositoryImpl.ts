...
export class StoreRepositoryImpl implements StoreRepository {
  async findAll(): Promise<Store[]> {
    ...
    return data.map((d: StoreWithUser) => new Store(d.store_id, d.name, d.address, d.phone, d.description, d.image_place_url, d.image_menu_url, "", d.users?.username ?? "", d.open_time));
  }
