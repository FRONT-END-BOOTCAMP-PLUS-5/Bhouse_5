...
export default function Home() {
  ...
  return (
    <div className={styles.page}>
      ...
      <h1 className={styles.body16}>환영합니다!</h1>
      <Divider marginY="8px" />
      <p className={styles.header20}>이것은 나눔스퀘어 레귤러 텍스트입니다.</p>
      <p className={styles.header48}>이것 텍스트입니다. (header48)</p>
      <p className={styles.extraBoldText}>이것은 나눔스퀘어 엑스트라볼드 텍스트입니다.</p>
      <p className={styles.extraBoldText}>
        이것은 나눔스퀘어 엑스트라볼드 텍스트입니다.이것은 나눔스퀘어 엑스트라볼드 텍스트입니다.이것은 나눔스퀘어
        엑스트라볼드 텍스트입니다.이것은 나눔스퀘어 엑스트라볼드 텍스트입니다.이것은 나눔스퀘어 엑스트라볼드
        텍스트입니다.이것은 나눔스퀘어 엑스트라볼드 텍스트입니다.이것은 나눔스퀘어 엑스트라볼드 텍스트입니다.이것은
        나눔스퀘어 엑스트라볼드 텍스트입니다.이것은 나눔스퀘어 엑스트라볼드 텍스트입니다.이것은 나눔스퀘어 엑스트라볼드
        텍스트입니다.이것은 나눔스퀘어 엑스트라볼드 텍스트입니다.이것은 나눔스퀘어 엑스트라볼드 텍스트입니다.이것은
        나눔스퀘어 엑스트라볼드 텍스트입니다.이것은 나눔스퀘어 엑스트라볼드 텍스트입니다.이것은 나눔스퀘어 엑스트라볼드
        텍스트입니다.이것은 나눔스퀘어 엑스트라볼드 텍스트입니다.이것은 나눔스퀘어 엑스트라볼드 텍스트입니다.이것은
        나눔스퀘어 엑스트라볼드 텍스트입니다.이것은 나눔스퀘어 엑스트라볼드 텍스트입니다.이것은 나눔스퀘어 엑스트라볼드
