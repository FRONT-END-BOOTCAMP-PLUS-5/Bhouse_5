...
export async function POST(request: NextRequest) {
  try {
    ...
    if (defaultImage) {
      ...
      console.log('[route] defaultImage instanceof File:', defaultImage instanceof File)
    ...
    const createMenuUsecase = new NCreateMenuUsecase(menuRepository, fileRepository, menuImageRepository)
    ...
    return NextResponse.json({ success: false, error: '메뉴 등록 중 오류가 발생했습니다.' }, { status: 500 })
  }
}
