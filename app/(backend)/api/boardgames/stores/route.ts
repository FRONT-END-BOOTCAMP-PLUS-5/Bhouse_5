...
// API 설명
{
// /boardgames/stores API
// 이 API는 특정 보드게임을 보유한 매장들의 정보를 조회합니다.
// 요청 예시:
// GET /api/boardgames/stores?boardgame_id=10
// 응답 예시:
// {
//   "message": "boardgame_id는 필수입니다.", //   "status": 400
//   "error": "보드게임 보유 매장 조회 실패" //   "status": 500
// }
// 성공적으로 조회된 경우, 매장 정보 배열을 반환합니다.
// 예시 응답:
// {
//   "store_id": 2,
//   "name": "행복한 주사위",
//   "address": "부산광역시 해운대구 센텀로 56"
// },
//   "store_id": 10,
//   "name": "게임리움",
//   "address": "서울특별시 마포구 독막로 25"
// }      
}
